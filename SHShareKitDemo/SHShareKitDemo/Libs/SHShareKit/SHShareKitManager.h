...
+ (void)shareToWeChatSessionWithTitle:(NSString *)title descriptions:(NSString *)descriptions thumbnailData:(NSData *)thumbnailData linkUrl:(NSString *)linkUrl successBlock:(WeChatShareResult)success failureBlock:(WeChatShareResult)failure;
+ (void)shareToWeChatTimelineWithTitle:(NSString *)title descriptions:(NSString *)descriptions thumbnailData:(NSData *)thumbnailData linkUrl:(NSString *)linkUrl successBlock:(WeChatShareResult)success failureBlock:(WeChatShareResult)failure;
